...
app.config(function($routeProvider){
	...
	.when('/getalljobapplications',{controller:'JobAppCtrl',templateUrl:'views/jobsapproval.html'})
	.when('/getjobnotification/:id',{controller:'JobApplicationCtrl',templateUrl:'views/JobNotification.html'})
})
